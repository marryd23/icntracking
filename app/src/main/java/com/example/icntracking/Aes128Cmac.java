...
public class Aes128Cmac {
	...
	private static byte[] const_Zero = ZMeshUtils.hexToBytes("00000000000000000000000000000000");
	private static byte[] const_Rb = ZMeshUtils.hexToBytes("00000000000000000000000000000087");
	...
	**/
	...
	{
		/* Step 1 */
		byte[] L = encryptAES128(const_Zero, key);
    ...
    private static byte[] encryptAES128(byte[] input,byte[] key){
